...
namespace GameChien.Controllers
{
    ...
    public class DepositController : Controller
    {
        ...
        public ActionResult GetAll(string searchText, int? curPage = 1)
        {
            ...
            string query = @"   select Id, CreatedTime, Amount, Status
		                                , ROW_NUMBER() over (order by CreatedTime desc) as r
                                from tblDeposit";
            string where = $" WHERE PlayerId = '{player.Id}'";
